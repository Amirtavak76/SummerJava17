...
public class House 
{
	...
	{
		this(name, school, new Vector<Student>(), null, new ArrayList<String>(), new TreeMap<Integer, Student>());
	}
	
	public House()
	{
		this("", null, new Vector<Student>(), null, new ArrayList<String>(), new TreeMap<Integer, Student>());
	}
