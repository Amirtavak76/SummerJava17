...
public class School
{
	...
	public School(String name, int numOfStudents, boolean housed, ArrayList<House> houses, Vector<Student> students, Vector<Professor> professors, ArrayList<Course> courses, String location)
	{
		_name = name;
	...
	{
		this(name, 0, housed, new ArrayList<House>(), new Vector<Student>(), new Vector<Professor>(), new ArrayList<Course>(), location);
	}
